...
#
# Easy zipline gallery management.
#
# optional arguments:
...
WEBPACK_COMMON="./node_modules/.bin/webpack './example/main.js' --output-path './web/example' --output-file '%s.js' --progress --colors"
...
def update_data():
  ...
  shutil.copy('example/data/2014.json', 'web/example/data/')
